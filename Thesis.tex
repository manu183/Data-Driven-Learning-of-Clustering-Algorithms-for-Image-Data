...
\advisorone{Prof. Dr. Marina Florina Balcan}
%% The second advisor can be omitted
%\advisortwo{Dr. Sebastian Stüker}

%% Please enter the start end end time of your thesis
\editingtime{January 1, 2019}{\today}
...
\input{Chapters/RelatedWork} % Related Work

\input{Chapters/AlphaLinkage}

\input{Chapters/BetaLinkage}

% \input{Chapters/AlphaBetaLinkage}

\input{Chapters/ExperimentalSetup} % Experimental Setup
